...
# eval "$(oh-my-posh init zsh --config ~/.slimtheme.omp.json)"
...
export ZSH="/Users/simon.parker1homegroup.org.uk/.oh-my-zsh"
...
alias vpnConnect="bash ~/./vpnConnect.sh"
alias vpnDisconnect="bash ~/./vpnDisconnect.sh"
